...
Usage:
    uv run python -m lab2.agent.run
"""
...
from lab2.agent.agent import process_patient
from lab2.agent.store import load_store, save_store
from lab2.agent.models import ConcernsStore
...
def main():
    logger.info("=== Lab 2: Observable Agent ===")
